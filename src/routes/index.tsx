...
const pastEvents = [
  { title: "Trancoso", image: photos.cafe.src },
  { title: "Ubatuba", image: photos.movimento.src },
  { title: "Florianópolis", image: photos.duoLaptop.src },
  { title: "Mais edições", image: photos.manifesto.src },
];
...
const partnerLogoSlots = Array.from({ length: 5 }, (_, index) => index + 1);
            ...
            >
              <article className="group relative h-full min-h-[17rem] overflow-hidden bg-ink md:min-h-0">
                <img
                  ...
                  loading="lazy"
                  className="h-full w-full object-cover transition-transform duration-[1200ms] ease-out group-hover:scale-[1.04] motion-reduce:transition-none"
                />
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-6 text-cream md:p-8">
                  <div>
                    <p className="eyebrow text-cream/70">Evento passado</p>
                    <h3 className="display mt-3 text-[2.25rem] md:text-[3rem]">
                      {event.title}
                    </h3>
                  </div>
        ...
        <ScrollReveal delay={180}>
          <div className="mt-6 border-y border-foreground/20 py-5 md:mt-8 md:py-6">
            ...
            <div
              ...
              aria-label="Cinco marcas parceiras dos últimos eventos"
            >
              <div
                ...
                aria-hidden="true"
              >
              {[...partnerLogoSlots, ...partnerLogoSlots].map((slot, index) => (
                <div
                  key={`${slot}-${index}`}
                  className="flex min-h-16 w-[13rem] shrink-0 items-center justify-center border-r border-foreground/15 bg-cream px-4 py-3 md:min-h-20 md:w-[18rem]"
                >
                  <span className="eyebrow text-center text-foreground/35">
                    Logo da marca {slot}
                  </span>
                </div>
              ))}
...
function JourneyTimeline() {
  return (
    <div className="shell relative mt-12 text-cream md:mt-16">
          ...
          <ol className="relative grid gap-4 before:absolute before:bottom-0 before:left-[0.45rem] before:top-0 before:w-px before:bg-cream/25 sm:grid-cols-5 sm:gap-3 sm:before:bottom-auto sm:before:left-0 sm:before:right-0 sm:before:top-[0.45rem] sm:before:h-px sm:before:w-auto">
            {journeySteps.map((step, index) => (
              <li key={step} className="relative pl-10 sm:pl-0 sm:pt-10">
                ...
                />
                <div
                  className={`min-h-[8.5rem] p-5 sm:min-h-[11rem] sm:p-5 lg:p-7 ${
                    index === journeySteps.length - 1
                      ? "bg-ochre text-ink"
                ...
                >
                  ...
                  <h3 className="display mt-5 text-[1.45rem] leading-tight md:text-[1.75rem]">
                    {step}
                  </h3>
                </div>
              </li>
...
function Hero() {
  return (
    <section className="bg-cream pt-20 text-foreground md:pt-24">
      <div className="relative min-h-[34rem] w-full overflow-hidden bg-sand md:aspect-[2/1] md:min-h-0">
        <img
          src={`${import.meta.env.BASE_URL}media/banner2.png`}
        ...
        <div className="absolute inset-x-0 bottom-7 z-10 px-7 sm:bottom-10 sm:px-10 md:left-[max(5.5%,calc((100vw-88rem)/2+4.84rem))] md:right-auto md:px-0">
    ...
    <section id="experiencias" className="experiences-section relative overflow-hidden bg-ink py-24 text-cream md:py-36">
      ...
      <div className="shell mt-16 md:mt-24">
        ...
        <ScrollReveal delay={80}>
          <h2 className="display mt-8 max-w-5xl text-[clamp(2.5rem,5vw,5rem)] uppercase leading-[0.9] tracking-[-0.03em]">
          ...
          <p className="mt-5 max-w-3xl text-base leading-relaxed text-cream/75 md:text-xl">
            Uma experiência criada para mulheres que ainda têm muito para viver.
          </p>
        </ScrollReveal>

        <div className="mt-10 grid gap-3 md:grid-cols-12 md:grid-rows-2 md:gap-4">
          <ScrollReveal className="flex min-h-[22rem] flex-col justify-between bg-cream p-7 text-foreground sm:p-9 md:col-span-7 md:row-span-2 md:min-h-[32rem] md:p-12">
            ...
            <div>
              <h3 className="display max-w-xl text-[clamp(2.75rem,5vw,5rem)] leading-[0.92]">
                Encontros presenciais
              </h3>
              <p className="mt-6 max-w-lg text-base leading-relaxed text-foreground/75 md:text-lg">
                Eventos e viagens para viver mais — e viver junto.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal
            delay={110}
            className="flex min-h-[16rem] flex-col justify-between bg-forest p-7 text-cream sm:p-9 md:col-span-5 md:min-h-0 md:p-10"
          >
            <div className="flex items-start justify-end gap-6">
              <span className="eyebrow text-ochre" aria-hidden="true">02</span>
            </div>
            <div className="mt-12">
              <h3 className="display text-[2.25rem] leading-none md:text-[3rem]">Encontros online</h3>
              <p className="mt-4 max-w-md text-base leading-relaxed text-cream/80">
                Conversas que ampliam o olhar e fazem a gente pensar no que vem depois.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal
            delay={220}
            className="flex min-h-[16rem] flex-col justify-between border border-cream/25 bg-ink p-7 text-cream sm:p-9 md:col-span-5 md:min-h-0 md:p-10"
          >
            <div className="flex items-start justify-end gap-6">
              <span className="eyebrow text-rose" aria-hidden="true">03</span>
            </div>
            <div className="mt-12">
              <h3 className="display text-[2.25rem] leading-none md:text-[3rem]">Clube</h3>
              <p className="mt-4 max-w-md text-base leading-relaxed text-cream/80">
                Mulheres por perto para trocar, compartilhar e fazer a vida acontecer.
              </p>
            </div>
          </ScrollReveal>
        </div>
...
function AgendaExperience() {
  ...
  return (
    <>
      <div id="agenda" className="relative mt-8 scroll-mt-20 overflow-hidden bg-forest text-cream md:scroll-mt-24">
        <div
        ...
        <div className="shell relative pb-10 pt-24 md:pb-14 md:pt-36">
          <div className="grid overflow-hidden bg-cream text-foreground shadow-2xl md:grid-cols-[0.72fr_1.28fr]">
            <aside className="relative overflow-hidden bg-terracotta-deep p-6 text-cream sm:p-8 md:min-h-[30rem] md:p-8">
              <img
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div>
                  ...
                  <p className="font-bebas mt-7 whitespace-nowrap font-normal text-[clamp(3.5rem,8vw,6rem)] leading-[0.78] tracking-[-0.06em]">
                    <span className="inline-block border-b-2 border-ochre pb-3">
                      <span className="inline-flex gap-[0.08em]"><span>0</span><span>4</span></span>{" "}
                      <span className="text-[0.38em] uppercase tracking-normal text-ochre">a</span>{" "}
                      <span className="inline-flex gap-[0.08em]"><span>0</span><span>6</span></span>
                    </span>
                ...
                <div className="mt-8 pt-5">
                  ...
                  <p className="display mt-3 text-[2.25rem]">Ubatuba - SP</p>
                </div>
              </div>
            </aside>
            ...
            <div className="p-6 sm:p-8 md:p-8">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-sm leading-relaxed text-foreground/75 md:text-base">
                  Quem disse que a gente não pode falar de negócios com os pés
                  na areia? E olha essa programação:
                </p>

                <div className="mt-6 border-t border-foreground/15 pt-5">
                  <ol className="grid gap-x-6 sm:grid-flow-col sm:grid-rows-4">
          ...
          >
            ...
            <div className="grid md:grid-cols-[0.72fr_1.28fr]">
              ...
              <div className="p-6 sm:p-8 md:p-8">
                ...
                <p id="agenda-description" className="mt-4 max-w-2xl text-xs leading-relaxed text-foreground/75 md:text-sm">
                  Quem disse que a gente não pode falar de negócios com os pés
                  na areia? E olha essa programação:
                </p>
...
function Manifesto() {
  ...
  return (
    <section id="o-liberte-se" className="relative overflow-hidden bg-cream py-20 md:py-32">
      <div
        aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-10 bottom-0 font-display text-[clamp(9rem,22vw,22rem)] leading-none tracking-[-0.08em] text-wine/[0.045]"
      >
        01
      </div>

      <div className="shell relative">
        <div className="mt-10 grid gap-10 lg:grid-cols-12 lg:items-start lg:gap-6">
          <div className="relative z-10 lg:col-span-7 lg:pt-8">
            <ScrollReveal>
              <h2 className="display mt-5 max-w-4xl text-[clamp(3rem,7vw,7rem)] leading-[0.78] tracking-[-0.06em]">
            ...
            <ScrollReveal delay={100}>
              <div className="mt-10 border-y border-foreground/20 lg:mr-[-5rem] lg:max-w-2xl">
                {partnerNotes.map((item, index) => (
                  <p
                    key={item}
                    className="grid grid-cols-[2rem_1fr] gap-4 border-b border-foreground/20 py-5 text-base leading-relaxed text-foreground/80 last:border-b-0 md:text-lg"
                  >
